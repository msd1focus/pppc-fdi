...
public class AppRolesImpl extends EntityImpl {
    ...
    public enum AttributesEnum {
        ...
        AddendumArea {
            public Object get(AppRolesImpl obj) {
                return obj.getAddendumArea();
            }

            public void put(AppRolesImpl obj, Object value) {
                obj.setAddendumArea((String)value);
            }
        }
        ,
        PrintCount {
            public Object get(AppRolesImpl obj) {
                return obj.getPrintCount();
            }

            public void put(AppRolesImpl obj, Object value) {
                obj.setPrintCount((String)value);
            }
        }
        ,
        Unapproved {
            public Object get(AppRolesImpl obj) {
                return obj.getUnapproved();
            }

            public void put(AppRolesImpl obj, Object value) {
                obj.setUnapproved((String)value);
            }
        }
        ,
        ApprovalBudget {
            public Object get(AppRolesImpl obj) {
                return obj.getApprovalBudget();
            }

            public void put(AppRolesImpl obj, Object value) {
                obj.setApprovalBudget((String)value);
            }
        }
        ,
        BudgetStatus {
            public Object get(AppRolesImpl obj) {
                return obj.getBudgetStatus();
            }

            public void put(AppRolesImpl obj, Object value) {
                obj.setBudgetStatus((String)value);
            }
        }
        ,
        AppRoleMenuItems {
    ...
    public static final int ADDENDUMAREA = AttributesEnum.AddendumArea.index();
    public static final int PRINTCOUNT = AttributesEnum.PrintCount.index();
    public static final int UNAPPROVED = AttributesEnum.Unapproved.index();
    public static final int APPROVALBUDGET = AttributesEnum.ApprovalBudget.index();
    public static final int BUDGETSTATUS = AttributesEnum.BudgetStatus.index();
    ...
    /**
     * Gets the attribute value for AddendumArea, using the alias name AddendumArea.
     * @return the AddendumArea
     */
    public String getAddendumArea() {
        return (String)getAttributeInternal(ADDENDUMAREA);
    }

    /**
     * Sets <code>value</code> as the attribute value for AddendumArea.
     * @param value value to set the AddendumArea
     */
    public void setAddendumArea(String value) {
        setAttributeInternal(ADDENDUMAREA, value);
    }

    /**
     * Gets the attribute value for PrintCount, using the alias name PrintCount.
     * @return the PrintCount
     */
    public String getPrintCount() {
        return (String)getAttributeInternal(PRINTCOUNT);
    }

    /**
     * Sets <code>value</code> as the attribute value for PrintCount.
     * @param value value to set the PrintCount
     */
    public void setPrintCount(String value) {
        setAttributeInternal(PRINTCOUNT, value);
    }

    /**
     * Gets the attribute value for Unapproved, using the alias name Unapproved.
     * @return the Unapproved
     */
    public String getUnapproved() {
        return (String)getAttributeInternal(UNAPPROVED);
    }

    /**
     * Sets <code>value</code> as the attribute value for Unapproved.
     * @param value value to set the Unapproved
     */
    public void setUnapproved(String value) {
        setAttributeInternal(UNAPPROVED, value);
    }

    /**
     * Gets the attribute value for ApprovalBudget, using the alias name ApprovalBudget.
     * @return the ApprovalBudget
     */
    public String getApprovalBudget() {
        return (String)getAttributeInternal(APPROVALBUDGET);
    }

    /**
     * Sets <code>value</code> as the attribute value for ApprovalBudget.
     * @param value value to set the ApprovalBudget
     */
    public void setApprovalBudget(String value) {
        setAttributeInternal(APPROVALBUDGET, value);
    }

    /**
     * Gets the attribute value for BudgetStatus, using the alias name BudgetStatus.
     * @return the BudgetStatus
     */
    public String getBudgetStatus() {
        return (String)getAttributeInternal(BUDGETSTATUS);
    }

    /**
     * Sets <code>value</code> as the attribute value for BudgetStatus.
     * @param value value to set the BudgetStatus
     */
    public void setBudgetStatus(String value) {
        setAttributeInternal(BUDGETSTATUS, value);
    }
