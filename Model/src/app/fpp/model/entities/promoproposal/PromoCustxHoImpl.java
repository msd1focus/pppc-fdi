...
// ---    Mon Dec 17 01:23:46 ICT 2018
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class PromoCustxHoImpl extends EntityImpl {
    ...
    public enum AttributesEnum {
        PromoCustxHoId {
            public Object get(PromoCustxHoImpl obj) {
                return obj.getPromoCustxHoId();
            }

            public void put(PromoCustxHoImpl obj, Object value) {
                obj.setPromoCustxHoId((DBSequence)value);
            }
        }
        ,
        PromoProdukId {
        ...
        public abstract Object get(PromoCustxHoImpl object);

        public abstract void put(PromoCustxHoImpl object, Object value);
    ...
    public static final int PROMOCUSTXHOID = AttributesEnum.PromoCustxHoId.index();
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject = EntityDefImpl.findDefObject("app.fpp.model.entities.promoproposal.PromoCustxHo");
        }
        return mDefinitionObject;
    }

    /**
     * Gets the attribute value for PromoCustxHoId, using the alias name PromoCustxHoId.
     * @return the PromoCustxHoId
     */
    public DBSequence getPromoCustxHoId() {
        return (DBSequence)getAttributeInternal(PROMOCUSTXHOID);
    }

    /**
     * Sets <code>value</code> as the attribute value for PromoCustxHoId.
     * @param value value to set the PromoCustxHoId
     */
    public void setPromoCustxHoId(DBSequence value) {
        setAttributeInternal(PROMOCUSTXHOID, value);
    }
    ...
    /**
     * @param promoCustxHoId key constituent

     * @return a Key object based on given key constituents.
     */
    public static Key createPrimaryKey(DBSequence promoCustxHoId) {
        return new Key(new Object[]{promoCustxHoId});
    }
    ...
    protected void create(AttributeList attributeList) {
        ...
        SequenceImpl seq = new SequenceImpl("PROMO_CUSTX_HO_SEQ", getDBTransaction());
        this.setPromoCustxHoId(new DBSequence(seq.getSequenceNumber()));
    }
}
