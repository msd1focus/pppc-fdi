package app.fpp.model.views.masterdata.runnumber;
...
public class RunNumPropViewRowImpl extends ViewRowImpl {
    ...
    public enum AttributesEnum {
        ...
        public int index() {
            return RunNumPropViewRowImpl.AttributesEnum.firstIndex() + ordinal();
        }
        ...
        public static int count() {
            return RunNumPropViewRowImpl.AttributesEnum.firstIndex() + RunNumPropViewRowImpl.AttributesEnum.staticValues().length;
        }

        public static final AttributesEnum[] staticValues() {
            if (vals == null) {
                vals = RunNumPropViewRowImpl.AttributesEnum.values();
            }
            return vals;
        }
    }
