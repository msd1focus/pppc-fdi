...
public class RunNumConfViewRowImpl extends ViewRowImpl {
    ...
    public enum AttributesEnum {
        ...
        public int index() {
            return RunNumConfViewRowImpl.AttributesEnum.firstIndex() + ordinal();
        }
        ...
        public static int count() {
            return RunNumConfViewRowImpl.AttributesEnum.firstIndex() + RunNumConfViewRowImpl.AttributesEnum.staticValues().length;
        }

        public static final AttributesEnum[] staticValues() {
            if (vals == null) {
                vals = RunNumConfViewRowImpl.AttributesEnum.values();
            }
            return vals;
        }
    }
