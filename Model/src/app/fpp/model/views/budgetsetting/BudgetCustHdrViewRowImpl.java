...
public class BudgetCustHdrViewRowImpl extends ViewRowImpl {
    ...
    public enum AttributesEnum {
        ...
        ,
        BudgetCustomerInsertView {
            public Object get(BudgetCustHdrViewRowImpl obj) {
                return obj.getBudgetCustomerInsertView();
            }
        ...
        ,
        AllKodePostingBudgetViewMF1 {
            public Object get(BudgetCustHdrViewRowImpl obj) {
                return obj.getAllKodePostingBudgetViewMF1();
            }
    ...
    public static final int BUDGETCUSTOMERINSERTVIEW = AttributesEnum.BudgetCustomerInsertView.index();
    ...
    public static final int ALLKODEPOSTINGBUDGETVIEWMF1 = AttributesEnum.AllKodePostingBudgetViewMF1.index();
    ...
    public String getCustomerDesc() {
        ...
        if (getCustomerId() != null) {
            ...
            if (custRows.length > 0) {
                ...
                custDesc = this.getCustomerId(); 
            }
            return custDesc;
        } else if (getKodePosting()!=null){
            PostId = this.getKodePosting();
            Row[] custRows;
            custRows = this.getAllKodePostingBudgetViewMF1().getFilteredRows("Item", PostId);
            if (custRows.length > 0) {
                postDesc = (custRows[0].getAttribute("ItemDescription").toString()).toUpperCase();
            } else {
                postDesc = this.getKodePosting();
            }
            return postDesc;
        }else {
    ...
    /**
     * Gets the associated <code>RowIterator</code> using master-detail link BudgetCustomerInsertView.
     */
    public RowIterator getBudgetCustomerInsertView() {
        return (RowIterator)getAttributeInternal(BUDGETCUSTOMERINSERTVIEW);
    }
    ...
    /**
     * Gets the view accessor <code>RowSet</code> AllKodePostingBudgetViewMF1.
     */
    public RowSet getAllKodePostingBudgetViewMF1() {
        return (RowSet)getAttributeInternal(ALLKODEPOSTINGBUDGETVIEWMF1);
    }
