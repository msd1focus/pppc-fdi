...
public class BudgetCustomerViewRowImpl extends ViewRowImpl {
    ...
    public enum AttributesEnum {
        ...
        ,
        BudgetCustomerInsertTran {
            public Object get(BudgetCustomerViewRowImpl obj) {
                return obj.getBudgetCustomerInsertTran();
            }
    ...
    public static final int BUDGETCUSTOMERINSERTTRAN = AttributesEnum.BudgetCustomerInsertTran.index();
    ...
    /**
     * Gets the associated <code>RowIterator</code> using master-detail link BudgetCustomerInsertTran.
     */
    public RowIterator getBudgetCustomerInsertTran() {
        return (RowIterator)getAttributeInternal(BUDGETCUSTOMERINSERTTRAN);
    }
