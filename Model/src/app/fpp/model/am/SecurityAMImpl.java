...
public class SecurityAMImpl extends CustomApplicationModuleImpl implements SecurityAM {
    ...
    public Map authenticateUser(String userLogin, String userPassword) {
        ...
        if (user.getEstimatedRowCount() > 0) {
            ...
            String reportDomainLoc = (String)userRow.getAttribute("ReportDomainLoc");
            String copyPpArea = (String)userRow.getAttribute("CopyPpArea");
            String userLogged = (String)userRow.getAttribute("UserLogged");
            String sessionTime = (String)userRow.getAttribute("SessionClrTime");
            String printCount = (String)userRow.getAttribute("PrintCount");
            String unApprove = (String)userRow.getAttribute("UnApprove");
            String budgetStatus = (String)userRow.getAttribute("BudgetStatus");
            String approvalBudget = (String)userRow.getAttribute("ApprovalBudget");
            String uploadUser = (String)userRow.getAttribute("UploadUser");
            String printMode = (String)userRow.getAttribute("PrintMode");
            String userCustPriv = (String)userRow.getAttribute("UserCustPriv");
            ...
            userData.put("UserCustPriv", userCustPriv);
            userData.put("ReportDomain", reportDomain);
            userData.put("ReportDomainLoc", reportDomainLoc);
            userData.put("CopyPpArea", copyPpArea);
            userData.put("UserLogged", userLogged);
            userData.put("SessionTime", sessionTime);
            userData.put("PrintCount", printCount);
            userData.put("UnApprove", unApprove);
            userData.put("BudgetStatus", budgetStatus);
            userData.put("ApprovalBudget", approvalBudget);
            userData.put("PrintMode", printMode);
            userData.put("UploadUser", uploadUser);
