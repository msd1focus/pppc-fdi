...
public class UserAccessMenuLeftManagedBean {
    ...
    private String manageUploadTaskFlowId = "/WEB-INF/ua-upload-users.xml#ua-upload-users";
    ...
    public TaskFlowId getDynamicTaskFlowId() {
        ...
        else if (this.getCurrentTF().equalsIgnoreCase("upload"))
            return TaskFlowId.parse(manageUploadTaskFlowId);
        else
            return TaskFlowId.parse(manageUserTaskFlowId);
    } 
